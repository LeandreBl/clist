...
#define clist_from_object(object_addr)                                                             \
	((clist(typeof(*object_addr)) *)((char *)object_addr                                       \
					 - offsetof(clist(typeof(*object_addr)), object)))
...
#define clist_foreach(item, list_ptr)                                                              \
	for (typeof((list_ptr)->object) *item = &(list_ptr)->object;                               \
	     ...
	     item = (((clist(typeof((list_ptr)->object)) *)clist_from_object(item))->base.next     \
		     == (void *)(list_ptr))                                                        \
			    ? NULL                                                                 \
...
#define clist_backward_foreach(list_ptr)                                                           \
	for (typeof((list_ptr)->object) *item = &(list_ptr)->object; item != NULL;                 \
	     item = (((clist(typeof((list_ptr)->object)) *)clist_from_object(item))->base.prev     \
		     == (list_ptr))                                                                \
			    ? NULL                                                                 \
