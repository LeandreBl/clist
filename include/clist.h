...
#define clist_init(list_ptr, destructor_fn) clist_generic_init(list_ptr, destructor_fn)
...
#define clist_next_object(list_ptr) (((typeof(list_ptr))(list_ptr)->base.next)->object)

#define clist_prev_object(list_ptr) (((typeof(list_ptr))(list_ptr)->base.prev)->object)

#define clist_from_object(object_addr)                                                                                 \
	((clist(typeof(*object_addr)) *)((char *)object_addr - offsetof(clist(typeof(*object_addr)), object)))
...
#define clist_foreach(item, list_ptr)                                                                                  \
	for (typeof((list_ptr)->object) *item = &(list_ptr)->object; list_ptr != NULL && item != NULL;                 \
	     item = (((clist(typeof((list_ptr)->object)) *)clist_from_object(item))->base.next == (void *)(list_ptr))  \
			    ? NULL                                                                                     \
			    : &(clist_next_object(clist_from_object(item))))

#define clist_backward_foreach(list_ptr)                                                                               \
	for (typeof((list_ptr)->object) *item = &(list_ptr)->object; item != NULL;                                     \
	     item = (((clist(typeof((list_ptr)->object)) *)clist_from_object(item))->base.prev == (list_ptr))          \
			    ? NULL                                                                                     \
			    : &(clist_prev_object(clist_from_object(item))))

#define clist_push_back(list_ptr, item, destructor_fn) clist_push_before(list_ptr, item, destructor_fn)
...
#define clist_remove(list_ptr)                                                                                         \
	do {                                                                                                           \
		clist_generic_remove(list_ptr);                                                                        \
		clist_assign((list_ptr)->base.prev, list_ptr);                                                         \
		clist_assign((list_ptr)->base.next, list_ptr);                                                         \
	} while (0)
